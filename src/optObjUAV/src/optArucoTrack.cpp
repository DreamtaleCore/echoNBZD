...
{
    ros::init(argc, argv, "optArucoTrack");
    ros::NodeHandle nh;
    ...
    //string defaultCameraParamPath = "/home/mylove/uavgp/ws/src/vision_uav/ca65.yml";
    string defaultCameraParamPath = "/home/mylove/ws/src/optObjUAV/ca65.yml";
    ...
    pub = nh.advertise<test_move::trackInfo>("optArucoTrack", 400);
