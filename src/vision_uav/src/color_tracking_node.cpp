...
#include "test_move/markerInfo.h"
...
int main(int argc,char **argv)
{
    ...
    pub = nh.advertise<test_move::markerInfo>("marker_pose",200);
...
void imageCallback(const sensor_msgs::ImageConstPtr& msg)
{
	...
	if(boundBox.x == -1)
	{
        ...
        outMsg.header.frame_id = "img_info";

        outMsg.pose.orientation.w = 0;
        outMsg.pose.orientation.x = 0;
        outMsg.pose.orientation.y = 0;
        outMsg.pose.orientation.z = 0;
        outMsg.pose.position.x = 0;
        outMsg.pose.position.y = 0;
        outMsg.pose.position.z = 0;
        outMsg.uv1.x = 0;
        outMsg.uv1.y = 0;
        outMsg.uv1.z = 0;
        outMsg.isTracking = 0;
