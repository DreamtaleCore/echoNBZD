...
{
    ros::init(argc, argv, "get_video_asi_node");
    ros::NodeHandle nh;
    ros::NodeHandle pnh("~");
    ...
    video = cvCreateVideoWriter("/home/mylove/nomarl_asi.avi", CV_FOURCC('X', 'V', 'I', 'D'), FrameRate, cvSize(FrameWidth,FrameHeight));
    ...
    imgSub = it.subscribe("/uav_cam_asi/image_asi", 10, imageCallback);
