...
String SearchCascadeName = "/home/g/ws/src/vision_uav/targetsearch.xml";//Looking for training data
String H_LandCascadeName = "/home/g/catkin_ws/src/view_for_uav/targetsearch.xml";//Identification of training data Landing

bool catch_bool = false;
bool search_bool = true,
     land_H_bool = false,
     track_bool = false,
     aim_square_bool =false;
int   center_x = 0,
      center_y = 0,
      radius = 0;
vector<Mat> channels;
...
Mat Image, ImageGRAY, mid,
    imageBlueChannel, imageGreenChannel, imageRedChannel,
    imageEqualize;
...
{
    ros::init(argc, argv, "vision_uav_node");
	ros::NodeHandle nh;
    ...
    pub = nh.advertise<geometry_msgs::Quaternion>("board_pose",200);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    if( search_bool==true)
    {
        ...
        imshow( "target search", mid );

    }
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    else if( land_H_bool==false)
    {
        ImageGRAY = imageEqualize;
        CascadeClassifier H_cascade;//Create a cascade classifier object

        if( !H_cascade.load( H_LandCascadeName ) )//Load cascade classifier from the specified file directory
        {
             cerr << "ERROR: Could not load classifier cascade" << endl;
             goto FUNC_END;
        }
        ...
        if( !ImageGRAY.empty() )//Read picture data can not be empty
        {
            Detect( ImageGRAY, H_cascade, scale );
            printf("Detect successfully\n");
        }
